...
| Rental marketplace | 12 | 9 | 1 | 1 | 1 | 75% | marketplace-engineering | Provider-independent transaction integrity and bounded frontend vertical slice implemented; executable PostgreSQL/RLS persistence pending |
