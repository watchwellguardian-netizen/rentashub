...
export function AdminDashboard() {
  ...
  const metrics = [
    ...
    ["Support cases", snapshot.overview.supportCases],
    ["Open support", snapshot.overview.openSupportCases],
    ["Support escalations", snapshot.overview.escalatedSupportCases],
