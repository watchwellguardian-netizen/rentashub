    ...
    <main className="page marketplace-page">
      ...
      <section className="panel wide">
        ...
        <div className="filter-grid">
          ...
          <label>Marketplace type<select value={filters.listingType} onChange={(event) => setFilter("listingType", event.target.value)}><option value="all">Rent, buy, sell, trade, swap, brokerage</option><option value="buy">Buy</option><option value="sell">Sell</option><option value="trade">Trade</option><option value="swap">Swap</option><option value="brokerage">Brokerage</option>{MARKETPLACE_LISTING_TYPES.map((item) => <option key={item} value={item}>{MARKETPLACE_LISTING_LABELS[item]}</option>)}</select></label>
