...
export const seedData = {
  users: [
    ...
    { id: "dealer-demo", name: "Owen Dealer", email: "owen@example.test", role: "dealer", status: "active", created_at: now, updated_at: now },
    { id: "inspector-demo", name: "Ivy Inspector", email: "ivy@example.test", role: "inspector", status: "active", created_at: now, updated_at: now },
    { id: "transport-demo", name: "Troy Transport", email: "troy@example.test", role: "transport_provider", status: "active", created_at: now, updated_at: now },
    { id: "financing-demo", name: "Fiona Financing", email: "fiona@example.test", role: "financing_partner", status: "active", created_at: now, updated_at: now },
  ...
  roles: [
    ...
    { id: "role-dealer", name: "dealer", description: "Can review dealer auction and marketplace activity placeholders.", created_at: now },
    { id: "role-inspector", name: "inspector", description: "Can manage assigned inspection marketplace workflows.", created_at: now },
    { id: "role-transport-provider", name: "transport_provider", description: "Can manage assigned transport marketplace workflows.", created_at: now },
    { id: "role-financing-partner", name: "financing_partner", description: "Can manage assigned financing referral workflows.", created_at: now },
