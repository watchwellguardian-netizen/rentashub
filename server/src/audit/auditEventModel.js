...
export const AUDIT_EVENT_CATEGORIES = {
  ...
  marketplace: ["assets.created", "assets.updated", "assets.deleted", "auctions.created", "auctions.approved", "auctions.rejected", "admin.auctions.updated"],
  operations: ["inspections.created", "inspections.updated", "transport.requested", "financing.referral.created"],
  ...
  payments: ["payments.simulated", "payments.refund_placeholder_requested", "payouts.simulated_requested", "escrow.created", "escrow.released", "escrow.disputed"],
