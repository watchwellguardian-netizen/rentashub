...
const featureRegister = [
  ...
  },
  {
    id: "auction-platform",
    module: "Auctions",
    feature: "Auction landing, lots, bidding UI, local contract layer, supplier/admin/dealer surfaces",
    weight: 5,
    completion: 0.7,
    frontendStatus: "Active route surface",
    backendStatus: "Provider-independent local auction contract service",
    databaseStatus: "Local/simulated data with idempotency records and audit trail",
    apiStatus: "No live auction exchange API certified",
    integrationStatus: "Provider independent and simulated",
    testStatus: "Auction local contract and workflow tests pass",
    classification: "locally-functional",
